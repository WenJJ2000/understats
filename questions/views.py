...
def decision_tree_view(request):
    ...
    if request.method == 'POST':
        ...
        # Retrieve the previous nodes and add it to the front of nodes. After the full recursion, the list "nodes" will have the entire pathway of nodes to the current node
